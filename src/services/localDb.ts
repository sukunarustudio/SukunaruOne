  ...
  materials: [
    {
      ...
      supplier: "",
      supplierContact: "",
      notes: "Contoh data bahan baku A",
      createdAt: "2026-01-01",
      updatedAt: "2026-01-01"
    },
    {
      ...
      supplier: "",
      supplierContact: "",
      notes: "Contoh data bahan baku B",
      createdAt: "2026-01-01",
      updatedAt: "2026-01-01"
    },
    {
      ...
      supplier: "",
      supplierContact: "",
      notes: "Contoh data bahan baku C",
      createdAt: "2026-01-01",
      updatedAt: "2026-01-01"
    }
  ],
  ...
  products: [
    {
      ...
      barcode: "",
      barcodeType: "CODE128",
      description: "Contoh data produk A",
      isActive: true,
      laborCost: 0,
      machineCost: 0,
      otherCost: 0,
    ...
    },
    {
      ...
      barcode: "",
      barcodeType: "CODE128",
      description: "Contoh data produk B",
      isActive: true,
      laborCost: 0,
      machineCost: 0,
      otherCost: 0,
    ...
    },
    {
      ...
      barcode: "",
      barcodeType: "CODE128",
      description: "Contoh data produk C",
      isActive: true,
      laborCost: 0,
      machineCost: 0,
      otherCost: 0,
